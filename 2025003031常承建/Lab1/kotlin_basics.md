...
fun main() {
    ...
    val myName = "常承建"       
    val myStudentId = "2025003031" 
    
    println("My name is $myName")
    println("My student ID is $myStudentId")
...
```kotlin
fun main() {
    println("Student 2025003031 says hello")
}
```
...
fun main() {
    changchengjian
    println("Hello, my name is changchengjian")
}
```
...
```kotlin
fun main() {
    println("ID: 2025003031") println("Name: changchengjian") println("Course: Kotlin")
}
```
...
```kotlin
fun main() {
    val changchengjianDelivery = "2025003031"
    println("Package for " + "changchengjian" + " will arrive, tracking ID: " + changchengjianDelivery + ".")
}
```
...
```kotlin
fun main() {
    val studentName = "changchengjian"   // 姓名拼音
    val score     = 31                   // 学号后两位的整数值
    val bonus     = 1                    // 学号最后一位
...
```kotlin
fun main() {
    println(changchengjianGreeting(age = 1))
    println(changchengjianGreeting("changchengjian", 3))
}

fun changchengjianGreeting(name: String = "2025003031", age: Int): String {
...
```kotlin
fun main() {
    printChangchengjianWeather("Ankara", 27, 31, 82)
    printChangchengjianWeather("Tokyo", 32, 36, 10)
    printChangchengjianWeather("Cape Town", 59, 64, 2)
    printChangchengjianWeather("Guatemala City", 50, 55, 7)
}

fun printChangchengjianWeather(city: String, lowTemp: Int, highTemp: Int, rainChance: Int) {
    println("City: $city")
